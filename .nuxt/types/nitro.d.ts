...
declare global {
  ...
  const cachedEventHandler: typeof import('C:/Development/victoria-window-cleaning/capstone/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('C:/Development/victoria-window-cleaning/capstone/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('C:/Development/victoria-window-cleaning/capstone/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('C:/Development/victoria-window-cleaning/capstone/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('C:/Development/victoria-window-cleaning/capstone/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('C:/Development/victoria-window-cleaning/capstone/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('C:/Development/victoria-window-cleaning/capstone/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('C:/Development/victoria-window-cleaning/capstone/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useNitroApp: typeof import('C:/Development/victoria-window-cleaning/capstone/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('C:/Development/victoria-window-cleaning/capstone/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useStorage: typeof import('C:/Development/victoria-window-cleaning/capstone/node_modules/nitropack/dist/runtime')['useStorage']
